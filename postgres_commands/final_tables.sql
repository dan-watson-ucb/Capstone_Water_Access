...
-- Load data from local csv
\copy sierraleone_preds FROM '/Users/Dan/Desktop/prediction_files/Sierra_Leone_w_outyear_predictions_coerced.csv'  DELIMITER ',' CSV HEADER;
...
-- Load data from local csv
\copy zimbabwe_preds FROM '/Users/Dan/Desktop/prediction_files/Liberia_w_outyear_predictions_coerced.csv'  DELIMITER ',' CSV HEADER;
